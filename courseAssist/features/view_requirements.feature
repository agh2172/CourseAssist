...
Background: users in database
    ...
    | Jackson    | Roberts     | 2023         | CC     | Computer Science | Ecnomonics       | jr3876 |
    | Sameer     | Saxena      | 2024         | SEAS   | Economics        | Computer Science | ss6167 |

    And I am on the home page

Scenario: user is in SEAS, majoring in Economics and minoring in Computer Science
...
Scenario: user is in CC, majoring in Computer Science and minoring in Economics

    When I fill in "UNI" with "jr3876"
    And I press "Enter"
    Then I should see "HUMA CC1001"
    And I should not see "CHEM CC1403"
    And I should see "COMS W1004"
